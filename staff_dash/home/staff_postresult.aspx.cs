...
public partial class secure_account_home : System.Web.UI.Page
{
    ...
    protected void UploadDoc(object sender, EventArgs e)
    {
        ...
        {
            FileUpload1.SaveAs(Server.MapPath("../../admin_dash/home/upload_docs/result/" + FileUpload1.PostedFile.FileName));
            filename.Value = FileUpload1.PostedFile.FileName;
            filepath.Value = "../../admin_dash/home/upload_docs/result/" + FileUpload1.PostedFile.FileName;
