<%@ Page Language="C#" AutoEventWireup="true" CodeFile="staff_postresult.aspx.cs" Inherits="secure_account_home" %>
...
<body>
    <div class="wrapper">
            ...
            <div class="blank-page-content">
                ...
                <!-- Error Page Info -->
                  ...
                  <div class="outer-w3-agile mt-3">
                    ...
                    <h3 style="text-align:center;color:#000; font-size:15px; font-weight:bold; font-family:Tahoma !important; color: #2471a3 ;">Post Result</h3>
      ...
      <input type="text" id="regno" runat="server" placeholder="Reg-NO" class="txtbox" />
      <input type="text" id="description" runat="server" placeholder="Result Description " class="txtbox" />
    <asp:FileUpload ID="FileUpload1" runat="server" class="browse" />
          ...
          <input type="hidden" id="filepath" runat="server" />
           ...
           <hr />
           <asp:Button ID="Button1" runat="server" Text="Submit" CssClass="btn_form" OnClick="saveupload"  />
