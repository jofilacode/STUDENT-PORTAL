<%@ Page Language="C#" AutoEventWireup="true" CodeFile="course.aspx.cs" Inherits="secure_account_home" %>
...
<body>
    <div class="wrapper">
                ...
                <!-- Error Page Info -->
                  ...
                  <div class="outer-w3-agile mt-3">
                    ...
                    <div class="paragraph-agileits-w3layouts">
                         ...
                         <h3 style="text-align:center;color:#000; font-size:15px; font-weight:bold; font-family:Tahoma !important; color: #2471a3 ; margin-top:20px;">My Courses</h3>
                  <form runat="server">
       ...
       <asp:GridView ID="courseData" runat="server" EmptyDataText="No Record Available Yet">
          ...
          <h3 style="text-align:center;color:#000; font-size:15px; font-weight:bold; font-family:Tahoma !important; color: #2471a3 ; margin:20px;">My Tutors</h3>
