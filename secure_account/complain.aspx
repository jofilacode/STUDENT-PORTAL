<%@ Page Language="C#" AutoEventWireup="true" CodeFile="complain.aspx.cs" Inherits="secure_account_home" %>
...
<body>
    <div class="wrapper">
            ...
            <div class="blank-page-content">
                ...
                <!-- Error Page Info -->
                  ...
                  <div class="outer-w3-agile mt-3">
                    ...
                    <h3 style="text-align:center;color:#000; font-size:15px; font-weight:bold; font-family:Tahoma !important; color: #2471a3 ; margin-top:20px;">Complain/Enquiry</h3>
       ...
       <textarea id="description" runat="server" placeholder="Description of request"  class="txtbox2"></textarea>
          <asp:Button ID="Button1" runat="server" Text="Submit" OnClick="savecontact" class="btn_form"  />
