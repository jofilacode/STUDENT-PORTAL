<%@ Page Language="C#" AutoEventWireup="true" CodeFile="result.aspx.cs" Inherits="secure_account_home" %>
            ...
            <div class="blank-page-content">
                ...
                <!-- Error Page Info -->
                  ...
                  <div class="outer-w3-agile mt-3">
                    ...
                    <h3 style="text-align:center;color:#000; font-size:15px; font-weight:bold; font-family:Tahoma !important; color: #2471a3 ; margin-top:20px;">My Result</h3>
              ...
              <table border="1">
               ...
               <asp:Repeater ID="resultData" runat="server" >
               <ItemTemplate>
                  <tr>
                      <td><%# Eval("reg_no") %></td>
                      ...
                      <td><a target="_blank" href='../../admin_dash/home/<%# Eval("path") %>' style="text-decoration:underline;color:blue;">View</a></td>
                  </tr>
                </ItemTemplate>
