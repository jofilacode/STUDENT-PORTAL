<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pin.aspx.cs" Inherits="secure_account_home" %>
...
<body>
    <div class="wrapper">
            ...
            <div class="blank-page-content">
                ...
                <!-- Error Page Info -->
                  ...
                  <div class="outer-w3-agile mt-3">
                    ...
                    <p style="text-align:center; font-size:15px;color: #212f3d;">GeneratePin</p>
     ...
     <asp:DropDownList ID="pin_no" runat="server" CssClass="txtbox2">
         <asp:ListItem>Number of pins to Generate</asp:ListItem>
         <asp:ListItem>10</asp:ListItem>
         <asp:ListItem>20</asp:ListItem>
         <asp:ListItem>30</asp:ListItem>
         <asp:ListItem>50</asp:ListItem>
        </asp:DropDownList>
          <asp:Button ID="Button1" runat="server" Text="Generate Pin" class="btn_form" OnClick="savepin" />
                             <hr />
                              <h3 style="text-align:center;color:#000; font-size:15px; font-weight:bold; font-family:Tahoma !important; color: #2471a3 ;">View Pins</h3>

                               <div style="padding:20px; overflow:scroll;">
           <asp:GridView ID="pinData" runat="server" EmptyDataText="No Record Available Yet">
