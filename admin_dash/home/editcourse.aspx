<%@ Page Language="C#" AutoEventWireup="true" CodeFile="editcourse.aspx.cs" Inherits="secure_account_home" %>
...
<body>
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="blank-page-content">
                ...
                <!-- Error Page Info -->
                  ...
                  <div class="outer-w3-agile mt-3">
                    ...
                    <p style="text-align:center; font-size:15px;color: #212f3d;">Edit Course</p>
          ...
          <div class="editpanel">
              <input type="text" id="searchbox" runat="server" placeholder="Search Course Code"  class="txtbox" />
