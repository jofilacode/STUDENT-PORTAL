    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="blank-page-content">
                ...
                <!-- Error Page Info -->
                  ...
                  <div class="outer-w3-agile mt-3">
                    ...
                    <p style="text-align:center; font-size:15px;color: #212f3d;">New Student Account</p>
                    ...
                    <div class="paragraph-agileits-w3layouts">
                        ...
                        <form runat="server">
                                  ...
                                  <input type="text" id="regno" runat="server" placeholder="registration Number" class="txtbox" />
           <asp:DropDownList ID="package" runat="server" CssClass="txtbox2">
            ...
            <asp:DropDownList ID="duration" runat="server" CssClass="txtbox2">
              <asp:ListItem>Duration</asp:ListItem>
              <asp:ListItem>1 Month</asp:ListItem>
              <asp:ListItem>3 Months</asp:ListItem>
              <asp:ListItem>6 Months</asp:ListItem>
          </asp:DropDownList>
      <input type="text" id="amount" runat="server" placeholder="amount" class="txtbox" />
      <input type="text" id="balance" runat="server" placeholder="Balance" class="txtbox" />
      <input type="text" id="pincode" runat="server" placeholder="Pin Code" class="txtbox" />
           <asp:DropDownList ID="status" runat="server" CssClass="txtbox2">
              <asp:ListItem>Payment Status</asp:ListItem>
              <asp:ListItem>Part Payment</asp:ListItem>
              <asp:ListItem>Full Payments</asp:ListItem>
          </asp:DropDownList>
          <asp:Button ID="Button1" runat="server" Text="Register" class="btn_form" OnClick="create_payment" />
