<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewresult.aspx.cs" Inherits="secure_account_home" %>
...
<body>
            ...
            <div class="blank-page-content">
                ...
                <!-- Error Page Info -->
                  ...
                  <div class="outer-w3-agile mt-3">
                    ...
                    <p style="text-align:center; font-size:15px;color: #212f3d;">View Result</p>
    ...
    <table border="1">
                  <tr>
                      ...
                      <td class="thead">Reg No</td>
                      <td class="thead">Description</td>
                      <td class="thead">Size</td>
                      <td class="thead">date</td>
                      <td class="thead">View</td>
                  </tr>
               <asp:Repeater ID="resultData" runat="server"  OnItemCommand="resultData_ItemCommand" >
               <ItemTemplate>
                  <tr>
                      ...
                      <td><a target="_blank" href='<%# Eval("path") %>' style="color:blue;text-decoration:underline;">View</a></td>
                  </tr>
                </ItemTemplate>
                    ...
                    <hr />
                    <h3 style="text-align:center;color:#000; font-size:15px; font-weight:bold; font-family:Tahoma !important; color: #2471a3 ; margin:20px;">View CBT Result</h3>
              ...
              <HeaderStyle  BackColor="#191919" ForeColor="White" />
                  <Columns>
                    <asp:TemplateField ShowHeader="False" >
                      <ItemTemplate>
                            <asp:Button ID="mydelbtn" CssClass="delbtn" runat="server" CausesValidation="false" CommandName="deletedata" style="background-color:#c0392b ;color:#fff; border:0; border-radius:5px;padding:5px; cursor:pointer;width:60px;"
