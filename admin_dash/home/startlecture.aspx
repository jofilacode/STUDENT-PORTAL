<%@ Page Language="C#" AutoEventWireup="true" CodeFile="startlecture.aspx.cs" Inherits="secure_account_home" %>
...
<body>
    <div class="wrapper">
            ...
            <div class="blank-page-content">
                ...
                <!-- Error Page Info -->
                  ...
                  <div class="outer-w3-agile mt-3">
                    ...
                    <p style="text-align:center; font-size:15px;color: #212f3d;">Start Lecture</p>
       ...
       <input type="text" id="tutor" runat="server" placeholder="Tutor" class="txtbox" />
          ...
          <h3 style="text-align:center;color:#000; font-size:15px; font-weight:bold; font-family:Tahoma !important; color: #2471a3 ;"> View Lecture</h3>
