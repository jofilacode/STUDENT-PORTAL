<%@ Page Language="C#" AutoEventWireup="true" CodeFile="addcourse.aspx.cs" Inherits="secure_account_home" %>
...
<body>
    <div class="wrapper">
            ...
            <div class="blank-page-content">
                ...
                <!-- Error Page Info -->
                  ...
                  <div class="outer-w3-agile mt-3">
                    ...
                    <p style="text-align:center; font-size:15px;color: #212f3d;">Add/View Course</p>
                    <div id="msg" runat="server" class="msg"> </div>
                    <div class="paragraph-agileits-w3layouts">
                        
                       <form runat="server" >
      <input type="text" id="coursecode" runat="server" placeholder="Course Code" class="txtbox" />
      <input type="text" id="coursetitle" runat="server" placeholder="Course Title" class="txtbox" />
      ...
      <input type="text" id="description" runat="server" placeholder="Description" class="txtbox" />
          <asp:Button ID="Button1" runat="server" Text="Submit" class="btn_form" OnClick="savecourse"  />
    <hr />
      <h3 style="text-align:center;color:#000; font-size:15px; font-weight:bold; font-family:Tahoma !important; color: #2471a3 ;">View Course</h3>
           
        <div style="padding:20px; overflow:scroll;">

          <asp:GridView ID="courseData" runat="server" EmptyDataText="No Record Available Yet">
