<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewrequest.aspx.cs" Inherits="secure_account_home" %>
...
<body>
            ...
            <div class="blank-page-content">
                ...
                <!-- Error Page Info -->
                  ...
                  <div class="outer-w3-agile mt-3">
                    ...
                    <h3 style="text-align:center;color:#000; font-size:15px; font-weight:bold; font-family:Tahoma !important; color: #2471a3 ;">View Request</h3>
    ...
    <asp:GridView ID="requestData" runat="server" EmptyDataText="No Record Available Yet">
