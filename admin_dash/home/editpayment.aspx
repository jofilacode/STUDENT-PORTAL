<%@ Page Language="C#" AutoEventWireup="true" CodeFile="editpayment.aspx.cs" Inherits="secure_account_home" %>
...
<body>
    <div class="wrapper">
            ...
            <div class="blank-page-content">
                ...
                <!-- Error Page Info -->
                  ...
                  <div class="outer-w3-agile mt-3">
                    ...
                    <p style="text-align:center; font-size:15px;color: #212f3d;">Edit Payment</p>
      ...
      <input type="text" id="balance" runat="server" placeholder="Balance" class="txtbox" />
           <asp:DropDownList ID="paystatus" runat="server" CssClass="txtbox2">
