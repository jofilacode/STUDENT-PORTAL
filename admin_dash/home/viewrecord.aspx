<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewrecord.aspx.cs" Inherits="secure_account_home" %>
...
<body>
    <div class="wrapper">
        ...
        <div id="content">
                ...
                <!-- Error Page Info -->
                  ...
                  <div class="outer-w3-agile mt-3">
                    ...
                    <p class="paragraph-agileits-w3layouts">
                        ...
                        <form runat="server">
                                   <h3 style="text-align:center;color:#000; font-size:15px; font-weight:bold; font-family:Tahoma !important; color: #2471a3 ;"> Student Record</h3>

                             <div style="padding:20px; overflow:scroll;">
                              <asp:GridView ID="recordData" runat="server" EmptyDataText="No Record Available Yet">
              <HeaderStyle  BackColor="#191919" ForeColor="White" />
               <Columns>
                   <asp:ImageField DataImageUrlField= "passport"  HeaderText="Photo" ControlStyle-Height="50px" ControlStyle-Width="50px" Visible></asp:ImageField>
               </Columns>
           ...
           <h3 style="text-align:center;color:#000; font-size:15px; font-weight:bold; font-family:Tahoma !important; color: #2471a3 ; margin-top:20px;"> Financial Record</h3>
             <div class="editpanel">
                   <div id="msg" runat="server" class="msg"> </div>
              <input type="text" id="searchbox" runat="server" placeholder="Enter Package Title"  class="txtbox" />
              <asp:Button ID="Button1" runat="server" Text="Search" class="btn_form" OnClick="search"  />
           
          </div>

                             <div style="padding:20px; overflow:scroll;">
           <asp:GridView ID="paymentData" runat="server" EmptyDataText="No Record Available Yet">
              <HeaderStyle  BackColor="#191919" ForeColor="White" />
