<%@ Page Language="C#" AutoEventWireup="true" CodeFile="edittutor.aspx.cs" Inherits="secure_account_home" %>
...
<body>
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="blank-page-content">
                ...
                <!-- Error Page Info -->
                  ...
                  <div class="outer-w3-agile mt-3">
                    ...
                    <p style="text-align:center; font-size:15px;color: #212f3d;">Edit Tutor</p>
          ...
          <div class="editpanel">
              <input type="text" id="searchbox" runat="server" placeholder="Search ID"  class="txtbox" />
      ...
      <input type="text" id="contactno" runat="server" placeholder="Contact Number" class="txtbox" />
          ...
          <input type="password" id="password" runat="server" placeholder="Password" class="txtbox" />
